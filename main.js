...
function updateCart() {
    ...
    let tottal_Price_input = document.getElementById("tottal_Price")
    ...
    tottal_Price_input.value = total_Price + 3
    count_Items_input.value = total_count
        ...
        cartItemsContainer.innerHTML += `
            ...
            <div class="item_cart">
                ...
                <div class="content">
                    <h4>${item.name}</h4>
                    <p class="price_cart">${total_Price_item} JD</p>
    ...
    if(checkout_items){
        ...
        subtotal_checkout.innerHTML= `${total_Price} JD`
        total_checkout.innerHTML= `${total_Price + 3} JD`
    }
